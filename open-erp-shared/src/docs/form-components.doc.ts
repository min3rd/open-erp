...
export const LABEL_DOC: ComponentDoc = {
  id: 'label',
  name: 'LabelComponent',
  selector: 'erp-label',
...
export const PASSWORD_INPUT_DOC: ComponentDoc = {
  id: 'password-input',
...
export const NUMBER_INPUT_DOC: ComponentDoc = {
  id: 'number-input',
...
export const TIME_PICKER_DOC: ComponentDoc = {
  id: 'time-picker',
...
export const DATE_RANGE_PICKER_DOC: ComponentDoc = {
...
export const COLOR_PICKER_DOC: ComponentDoc = {
  id: 'color-picker',
...
export const AUTOCOMPLETE_DOC: ComponentDoc = {
  id: 'autocomplete',
...
export const TAG_INPUT_DOC: ComponentDoc = {
  id: 'tag-input',
...
export const RICH_TEXT_EDITOR_DOC: ComponentDoc = {
  id: 'rich-text-editor',
...
export const OTP_INPUT_DOC: ComponentDoc = {
  id: 'otp-input',
...
export const SUBMIT_BUTTON_DOC: ComponentDoc = {
  id: 'submit-button',
...
export const RESET_BUTTON_DOC: ComponentDoc = {
  id: 'reset-button',
...
export const HELPER_TEXT_DOC: ComponentDoc = {
  id: 'helper-text',
