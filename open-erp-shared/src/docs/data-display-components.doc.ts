...
export const AVATAR_GROUP_DOC: ComponentDoc = {
  id: 'avatar-group',
  name: 'Avatar Group',
...
export const TIMELINE_DOC: ComponentDoc = {
  id: 'timeline',
  name: 'Timeline',
...
export const TREE_VIEW_DOC: ComponentDoc = {
  id: 'tree-view',
  name: 'Tree View',
...
export const STATISTIC_DOC: ComponentDoc = {
  id: 'statistic',
...
export const DESCRIPTIONS_DOC: ComponentDoc = {
  id: 'descriptions',
...
export const IMAGE_DOC: ComponentDoc = {
  id: 'image',
