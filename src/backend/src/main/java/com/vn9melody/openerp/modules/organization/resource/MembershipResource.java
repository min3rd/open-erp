 ...
 *
 * <p>TODO(wave-integration): attach {@code @RequirePermission("core:membership:read")} /
 * {@code @RequirePermission("core:membership:manage")} once the shared annotation ships.</p>
 */
