...
- **Ghi chú QA (2026-09-18)**: Form doanh nghiệp 2 bước + live slug check (debounce 400ms, preview URL) + nút gửi lại OTP 60s; browser verify 6/6 PASS; backend bổ sung GET /auth/check-slug.
