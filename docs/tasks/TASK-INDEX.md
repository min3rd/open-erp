...
| TASK-SPRINT-01-FRONTEND-001      | Angular Web — Auth UI + Trang Đăng ký DN (Angular 21) (AC: Light/Dark mode + persistence openErp.colorMode) | frontend   | Frontend | 8  | ⬜ TODO    | TASK-SPRINT-01-AUTH-001, -002, -003     | [Link](sprints/SPRINT-01/frontend/TASK-SPRINT-01-FRONTEND-001-angular-auth-ui.md) |
