...
|---------------|-----------|--------------|------|-------------|--------|------|---------|
| system-admin  | 7         | 42 SP        | 7    | 0           | 0      | 0    | 0       |
| frontend      | 3         | 19 SP        | 3    | 0           | 0      | 0    | 0       |
| mobile        | 1         | 8 SP         | 1    | 0           | 0      | 0    | 0       |
| ai            | 1         | 5 SP         | 1    | 0           | 0      | 0    | 0       |
| **Tổng**      | **12**    | **74 SP**    | **12** | **0**     | **0**  | **0**| **0**   |
...
| TASK-SPRINT-02-FRONTEND-001    | Angular Web — RBAC UI nâng cao                       | frontend      | Frontend | 8  | —          | ⬜ TODO    | TASK-SPRINT-01-FRONTEND-002, TASK-SPRINT-02-SYSTEM_ADMIN-001           | [Link](frontend/TASK-SPRINT-02-FRONTEND-001-rbac-ui.md) |
| TASK-SPRINT-02-FRONTEND-002    | Angular Web — Audit Log UI                           | frontend      | Frontend | 3  | —          | ⬜ TODO    | TASK-SPRINT-01-FRONTEND-002, TASK-SPRINT-02-SYSTEM_ADMIN-002           | [Link](frontend/TASK-SPRINT-02-FRONTEND-002-audit-log-ui.md) |
| TASK-SPRINT-02-FRONTEND-003    | Angular Web — Catalog và Dynamic Form Builder UI     | frontend      | Frontend | 8  | —          | ⬜ TODO    | TASK-SPRINT-01-FRONTEND-002, TASK-SPRINT-02-SYSTEM_ADMIN-003, TASK-SPRINT-02-SYSTEM_ADMIN-004 | [Link](frontend/TASK-SPRINT-02-FRONTEND-003-catalog-dynamic-form-ui.md) |
| TASK-SPRINT-02-MOBILE-001      | Ionic Angular — Thiết lập mobile và màn hình Auth   | mobile        | Mobile   | 8  | —          | ⬜ TODO    | TASK-SPRINT-01-AUTH-001                                                | [Link](mobile/TASK-SPRINT-02-MOBILE-001-ionic-auth-setup.md) |
...
- [ ] Tất cả 12 tasks có trạng thái DONE hoặc REVIEW
