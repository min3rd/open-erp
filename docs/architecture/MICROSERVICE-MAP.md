...
| `audit-service`        | 3006 | AuditModule        | audit_logs                                                    | —                                     | _._ (all events)                  |
...
| `ai-agent-service`     | 3018 | AiAgentModule      | ai_conversations, ai_tasks                                    | ai.suggestion, ai.alert               | _._ (selected events)             |
| `dashboard-service`    | 3019 | DashboardModule    | — (read from other services)                                  | —                                     | _._ (selected events)             |
