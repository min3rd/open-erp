...
--font-display: 'Cal Sans', 'Inter', -apple-system, BlinkMacSystemFont,
                'Segoe UI', sans-serif;
...
.text-display-xl  { font-family: var(--font-display); font-size: 64px; font-weight: 600; letter-spacing: -0.04em; }
.text-display-lg  { font-family: var(--font-display); font-size: 48px; font-weight: 600; letter-spacing: -0.03em; }
.text-title-lg    { font-family: var(--font-body); font-size: 22px; font-weight: 600; }
.text-title-md    { font-family: var(--font-body); font-size: 18px; font-weight: 600; }
.text-body-md     { font-family: var(--font-body); font-size: 16px; font-weight: 400; }
.text-body-sm     { font-family: var(--font-body); font-size: 14px; font-weight: 400; }
.text-caption     { font-family: var(--font-body); font-size: 13px; font-weight: 500; }
.text-button      { font-family: var(--font-body); font-size: 14px; font-weight: 600; }
```
...
```html
<div class="form-group">         <!-- gap-top: 16px -->
  <label class="form-label">    <!-- 14px/600, #111111, mb-6px -->
    Tên trường <span class="required">*</span>
  </label>
  <input class="text-input" />
  <p class="form-helper">       <!-- 13px/400, #6b7280, mt-4px -->
...
*Tài liệu này là nguồn sự thật duy nhất (single source of truth) cho toàn bộ quyết định thiết kế trong dự án Open ERP. Mọi thay đổi phải được cập nhật vào đây trước khi triển khai.*
