...
| **BUG-1.6** | Lỗi link kích hoạt trên môi trường dev | Link kích hoạt tài khoản được sinh tĩnh trỏ về domain cloud và chứa subdomain khiến không thể active được khi chạy dev local. | [x] Completed | BE Leads | [bug_06_activation_link.md](./bug_06_activation_link.md) |
