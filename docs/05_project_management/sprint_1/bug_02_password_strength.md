...
* **Vị trí hiển thị**: Bên dưới trường nhập liệu Password của [RegisterComponent](file:///c:/Users/Minh/Documents/open-erp/open-erp-web/src/app/features/auth/register/register.component.ts) và phía trên thông báo validation thông thường.
